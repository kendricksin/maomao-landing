...
export const Content10DataSource = {
  wrapper: {
    className: 'home-page-wrapper content1-wrapper m9zv0x8th5m-editor_css',
  },
...
export const Feature20DataSource = {
  wrapper: {
    className: 'home-page-wrapper content2-wrapper m9zuyodw6pf-editor_css',
  },
  ...
  title: {
    className: 'content2-title m9zuw7ri40a-editor_css',
    children: (
      <span>
        <span>
          <span>
  ...
  content: {
    className: 'content2-content m9zuwty0vj-editor_css',
    children: (
      <span>
        <p>
